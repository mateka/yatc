...
BOOST_AUTO_TEST_CASE(rotate_zero)
{
	coordinate pt{ 0, 0 };
	pt.rotate(rotation::ccw);
	BOOST_TEST(pt == coordinate(0, 0));
}
...
{
	BOOST_TEST(coordinate(2, 2) < coordinate(3, 2));
	BOOST_TEST(coordinate(1, 2) < coordinate(1, 4));
}

BOOST_AUTO_TEST_CASE(less_equal)
{
	BOOST_TEST(coordinate(2, 2) <= coordinate(2, 2));
	BOOST_TEST(coordinate(2, 2) <= coordinate(3, 2));
	BOOST_TEST(coordinate(1, 2) <= coordinate(1, 4));
}
...
{
	BOOST_TEST(coordinate(3, 2) > coordinate(2, 2));
	BOOST_TEST(coordinate(1, 4) > coordinate(1, 2));
}
